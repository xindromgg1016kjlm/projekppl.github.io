...
<body>
    ...
    <div class="content">
        <div class="container">
            ...
            <!-- Penjelasan Sistem -->
            <h2 class="mt-4">Tentang Sistem Siprobat</h2>
            <p class="text-justify">
                Siprobat adalah sebuah alat bantu berbasiu web yang memanfaatkan metode *Weighted Product* untuk melakukan analisis terhadap berbagai alternatif keputusan. Dengan sistem ini, Anda dapat dengan mudah mengidentifikasi alternatif terbaik berdasarkan nilai-nilai kriteria yang telah ditentukan.
            </p>
